...
Since the beginning of April, there's been a distinct periodicity in case reports. In particular, we can observe spikes in the number of cases reported every Friday over the past several weeks. This likely indicates the weekly routine of human activity, as everybody adjusted to the "new normal" after the inital spread of the virus.
...
ggplot( Cy, aes(x=DOW, y=New) ) + 
  scale_y_continuous(limits=c(15000,40000), breaks=ys) +
  scale_x_discrete() +
  scale_color_manual( values=ggthemes::few_pal()(5) ) +
